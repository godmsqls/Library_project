...
namespace LibraryProject.Views
{
    public class Curation : Form
    {
        ...
        public Curation()
        {
            ...
            Label lblChart = new Label { Text = "대출 통계", Location = new Point(30, 20), AutoSize = true, Font = new Font("Arial", 12, FontStyle.Bold) };
            ...
            Label lblRecommend = new Label { Text = "AI 추천 도서", Location = new Point(30, 270), AutoSize = true, Font = new Font("Arial", 12, FontStyle.Bold) };
        ...
        private void PnlChartBase_Paint(object sender, PaintEventArgs e)
        {
            ...
            int currentY = margin;
            int maxBarWidth = pnlChartBase.Width - 250;
            ...
            foreach (var kvp in categoryCounts)
            {
                ...
                e.Graphics.DrawString(kvp.Value.ToString() + "권", new Font("Arial", 9), Brushes.Black, new PointF(150 + barWidth + 5, currentY + barHeight / 2 - 7));
