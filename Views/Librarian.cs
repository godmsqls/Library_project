...
namespace LibraryProject.Views
{
    public class Librarian : Form
    {
        ...
        public void DisplayOverdueLoans(System.Collections.Generic.List<Models.LoanRecord> overdueLoans)
        {
            ...
            {
                // 1. 사서 관리자 화면에서 볼 필요가 없는 내부 고유 PK 시스템 ID 열은 숨김
                ...
                // 2. [컬럼명 한국어 매핑] 직관적인 업무용 한글 단어로 수정
                if (dgvOverdue.Columns["LoanId"] != null) dgvOverdue.Columns["LoanId"].HeaderText = "대출 ID";
                ...
                // 4. [가로 핏 조절] 글자 수 분포가 가장 많은 도서 제목의 가로 채우기 비중(FillWeight) 가중치 부여
